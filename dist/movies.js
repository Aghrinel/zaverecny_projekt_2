...
const selectSerial = document.querySelector('.movie-select');
// Najde sekci, do které se budou vykreslovat nalezené seriály
const movieSelection = document.querySelector('.serials');
// Funkce vytvoří jeden blok s obrázkem seriálu
const addSerialToWebsite = (image) => {
    // Vytvoří nový div
...
const getAllSerial = (selectValue) => {
...
selectSerial === null || selectSerial === void 0 ? void 0 : selectSerial.addEventListener('change', () => {
