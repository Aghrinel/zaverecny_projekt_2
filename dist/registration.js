...
const validateTextField = (control) => {
...
const formular = document.querySelector(".form-registration");
const mail = document.querySelector(".registration-mail");
...
const password = document.querySelector(".password-required");
const passwordError = document.querySelector(".notificationPasswordRequired");
const confirmPassword = document.querySelector(".password-confirm");
const confirmPasswordError = document.querySelector(".notificationPasswordConfirm");
...
confirmPassword === null || confirmPassword === void 0 ? void 0 : confirmPassword.addEventListener("blur", () => {
    validateConfirmPassword();
});
formular === null || formular === void 0 ? void 0 : formular.addEventListener("submit", (event) => {
